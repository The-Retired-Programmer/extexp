...
/**
 * The Factory creating XSLT Executors.
 * 
 * @author richard linsdale
 */
@ServiceProvider(service = ExecutorFactory.class)
public class XsltExecutorFactory implements ExecutorFactory {

    @Override
    public Executor create(String name) {
        return name.equals("xslt") ? new XsltExecutor() : null;
    }

    @Override
    public void consumeAllExecutors(Consumer<Executor> consumer) {
        consumer.accept(new XsltExecutor());
    }
}