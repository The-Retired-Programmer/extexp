 ...
 * 
 * Create an imageset Html tag.  Scans the resources folder for all images matching the named image
 * and so are assumed to be all part of the imageset.  The output is writer to the named IOWriter.
 * 
 * Requires parameters:
 * 
...
public class ImagesetExecutor extends Executor {
    ...
    protected void executecommand() {
        ...
        try {
            ...
            ee.errln("Error while creating Imageset tag: " + ex.getLocalizedMessage());
        }
        output.close();
    }
}
