 ...
 *
 * 'Use' - the name of the command sequence to execute
 *
...
public class UseControl extends Control {
    ...
    public String[] getPrimaryPinData(){
        return new String[] {"Use", "path", "inputpath"};
    }
    ...
    protected void executecommand() {
        ...
        execseq(ee.commandsequences.getSequence(getParameter("Use")), newee);
    }
}
