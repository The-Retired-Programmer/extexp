...
public class MarkdownAndSubstituteExecutor extends Executor {
    ...
    public PNode createNode(PScene scene, Position position) {
        return new MarkdownAndSubstituteNode(scene, position);
    }

    private class MarkdownAndSubstituteNode extends PNode {

        @SuppressWarnings("LeakingThisInConstructor")
        public MarkdownAndSubstituteNode(PScene scene, Position position) {
